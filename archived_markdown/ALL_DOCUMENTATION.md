<!-- Combined documentation generated on 2026-05-27 -->
# ALL DOCUMENTATION (Combined)

Generated by consolidation on 2026-05-27.
...
## Externalized Documents

The following focused documents have been split out for clarity and quick access:

- `API.md` — function reference and data formats
- `PRESENTATION_GUIDE.md` — elevator pitches and presentation flows
- `PROJECT_SUMMARY.md` — concise project completion summary
- `QUICK_REFERENCE.md` — one-page quick usage and stats

Refer to those files for dedicated content. The rest of this combined file retains the high-level overview and model performance summary.

---

## Remaining High-level Overview (from README)
...
For more details, open the individual files listed above.
